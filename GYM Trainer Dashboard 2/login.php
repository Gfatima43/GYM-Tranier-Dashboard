...
// Get error/success messages and form state from session or URL
                    ...
                    <div class="form-card p-4">
                        ...
                        <form id="signupForm" class="login-form" method="POST" action="Authority/auth.php">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control input-field" id="signup-phone" name="phone" placeholder="Enter phone number" value="<?= isset($_POST['phone']) ? htmlspecialchars($_POST['phone']) : ''; ?>" required>
                            </div>
