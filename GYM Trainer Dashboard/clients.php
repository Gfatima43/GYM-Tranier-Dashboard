                    ...
                    <div class="select">
                        <?php if ($role === 'admin'): ?>
                            <select name="trainer_id">
                                ...
                                <?php
                                $trainers = $pdo->query("SELECT id,name FROM users WHERE role='trainer'");
                                while ($t = $trainers->fetch()) {
    ...
    <div class="modal-overlay" id="addModal">
        <div class="modal-box">
            ...
            <form method="POST" action="clients.php">
                ...
                <div style="margin-bottom:1.4rem"><label class="gym-label">Phone</label><input type="text" name="phone" class="gym-input" placeholder="+1 000 000 0000"></div>
                <div class="form-row" style="margin-bottom:1.4rem">
