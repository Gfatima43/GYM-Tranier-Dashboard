...
<body>
    ...
    <!-- <aside class="sidebar" id="sidebar">
        <div class="sidebar-brand">
            ...
            <div>
                <div class="brand-name">Gym</div>
                <div class="brand-sub">Trainer Hub</div>
            </div>
        </div>
        <div class="sidebar-profile">
            <div class="sidebar-avatar">IM</div>
            <div class="sidebar-profile-info">
                <div class="name">Irfan Malik</div>
                <div class="role">Head Trainer</div>
            </div>
            <div class="online-dot"></div>
        </div>
        <nav class="sidebar-nav">
            <div class="nav-section-label">Main</div>
            <a class="nav-item-link" href="dashboard.php"><span class="nav-icon"><i class="fas fa-chart-column"></i></span>Dashboard</a>
            <a class="nav-item-link" href="overview.php"><span class="nav-icon"><i class="fas fa-chart-line"></i></span>Overview</a>
            <div class="nav-section-label">Clients</div>
            <a class="nav-item-link" href="clients.php"><span class="nav-icon"><i class="fas fa-users"></i></span>My Clients<span class="nav-badge">8</span></a>
            <a class="nav-item-link" href="workout-plan.php"><span class="nav-icon"><i class="fas fa-dumbbell"></i></span>Workout Plans<span class="nav-badge">6</span></a>
            <div class="nav-section-label">Management</div>
            <a class="nav-item-link" href="schedule.php"><span class="nav-icon"><i class="fas fa-calendar-days"></i></span>Schedule</a>
            <a class="nav-item-link" href="attendance.php"><span class="nav-icon"><i class="fas fa-clipboard-check"></i></span>Attendance<span class="nav-badge danger">3</span></a>
            <a class="nav-item-link active" href="message.php"><span class="nav-icon"><i class="fas fa-comment-dots"></i></span>Messages<span class="nav-badge danger">5</span></a>
            <div class="nav-section-label">Account</div>
            <a class="nav-item-link" href="profile.php"><span class="nav-icon"><i class="fas fa-user-circle"></i></span>Profile</a>
        </nav>
        <div class="sidebar-footer"><button class="btn-logout" onclick="location.href='login.php'"><i class="fas fa-arrow-right-from-bracket"></i>Logout</button></div>
    </aside> -->
    <header class="topbar">
